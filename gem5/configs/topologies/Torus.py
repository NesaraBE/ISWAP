...
# Lab 2 - Exercise - Torus implementation
...
# Creates a generic Torus assuming an equal number of cache
        ...
        for row in xrange(num_rows):
            for col in xrange(num_columns):
                if (col + 1 <= num_columns): #check for functionality here
                    ...
                    west_in = (((col + 1) + (row * num_columns)) % num_columns) + (row * num_columns)
        ...
        for row in xrange(num_rows):
            for col in xrange(num_columns):
                if (col + 1 <= num_columns):
                    ...
                    west_out = (((col + 1) + (row * num_columns)) % num_columns) + (row * num_columns)
